...
module.exports = { helperFunction22, formatOutput, sanitizeInput };


// Helper functions

function helperFunction39(x) {
    return x * 39;
}
...
module.exports = { helperFunction39, formatOutput, sanitizeInput };
